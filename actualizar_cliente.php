...
if ($_SERVER["REQUEST_METHOD"] == "POST") { /*Verifica si la solicitud fue realizada por el método POST*/
    ...
    $campos_validos = ['nombreCliente', 'apellidoCliente', 'dniCliente', 'emailCliente','telefonoCliente','fecha_nacimientoCliente', 'contrasenaCliente'];
    ...
    if (in_array($campo, $campos_validos)) {
        ...
        $stmt->bind_param("si", $valor, $id_cliente);
